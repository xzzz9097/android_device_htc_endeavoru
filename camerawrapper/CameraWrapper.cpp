...
const static char * scene_mode_values[] = {"auto,action,portrait,landscape,beach,fireworks,night,night-portrait,snow,sports,steadyphoto,sunset,theatre,barcode,candlelight,backlight-hdr,text,closeup,back-light,backlight_portrait,beauty-mode,flowers,white-board,background-blur","auto"};
